...
/**
 * Controller method for comment and rate
 */
@RestController
public class CommentAndRateController {
     ...
     * @return save the list of comment and rate to service
     */
     ...
     * @return the comment and rate list from service by id
     */
     ...
     * @return list of all attributes of the comment and rate entity which are comment and rate id, comment and rate
     */
